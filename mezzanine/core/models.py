...
class Slugged(SiteRelated):
    ...
    title = models.CharField('d.N.I:', max_length=500)
    ...
    def admin_pdf_link(self):
        return "<a href='%s'>%s</a>" % (self.get_absolute_url(),
                                        ugettext("VER .PDF"))
    def admin_nuevo_estudio(self):
        return "<a href=../estudio/add/> +Estudios</a>"
    def admin_hc_link(self):
        return "<a href='%shc'>%s</a>" % (self.get_absolute_url(),
                                        ugettext("VER HC"))
    admin_link.allow_tags = True
    admin_link.short_description = ""
    admin_pdf_link.allow_tags = True
    admin_pdf_link.short_description = "PDF"
    admin_hc_link.allow_tags = True
    admin_hc_link.short_description = "H. C."
    admin_nuevo_estudio.allow_tags = True
    admin_nuevo_estudio.short_description = "N.Estudio"
...
class Displayable(Slugged, MetaData, TimeStamped):
    ...
    """
    #TODO aqui van todos los campos
    nombre = models.CharField(max_length=150, blank=True, null=True)
    apellido = models.CharField(max_length=50, blank=True, null=True)
    telefono = models.IntegerField(max_length=40, blank=True, null=True)
    email = models.CharField(max_length=50, blank=True, null=True)
    fecha_de_nacimento = models.DateField(blank=True, null=True,verbose_name="F. Nac.")
    domicilio= models.CharField(max_length=100, blank=True, null=True,verbose_name="Dom.")
    obra_social= models.CharField(max_length=100, blank=True, null=True,verbose_name='O.S.')
    obra_social_numero=models.CharField(max_length=40, blank=True, null=True,verbose_name="N°")
    obra_social_plan=models.CharField(max_length=40, blank=True, null=True,verbose_name='Plan')
    motivo_de_consulta= models.TextField(default="",blank=True, null=True,verbose_name="M.C.")
    antecedentes_personales=models.TextField(default="", blank=True, null=True,verbose_name="A.Oft.")
    antecedentes_personales_p=models.TextField(default="", blank=True, null=True,verbose_name="A.P.P.")

    observaciones = models.CharField(default="",max_length=100, blank=True, null=True)
    ...
    search_fields = {"keywords": 5, "title": 10,"nombre":1}
